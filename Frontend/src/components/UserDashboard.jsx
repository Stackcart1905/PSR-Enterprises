...
export default function UserDashboard() {
  ...
  const { notifications, unreadCount, initSocketListeners } =
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card className="border-none shadow-sm">
                <CardHeader>
                  ...
                  <CardDescription>
                    Your most recent order details
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  {lastOrder ? (
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge
                          className={`${getStatusColor(lastOrder.status)} border rounded-full`}
                        >
                      ...
                      <div className="space-y-2 text-sm text-gray-600">
                        ...
                        <div className="flex items-center">
                          ...
                          <span className="truncate">
                            {lastOrder.deliveryInfo?.addressText}
                          </span>
                        </div>
                      </div>
                    ...
                    {orders.slice(0, 3).map((order) => (
                      ...
                      >
                        ...
                        <div className="text-right">
                          ...
                          <Badge
                            variant="outline"
                            className={`text-[10px] ${getStatusColor(order.status)} border rounded-full`}
                          >
                            {order.status}
                          </Badge>
                        </div>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      {toast && (
        <div className="fixed top-6 right-6 z-[100] animate-in slide-in-from-right-full duration-500">
          <Card
            className={`w-80 border-none shadow-2xl overflow-hidden ${toast.type === "success" ? "bg-green-900 text-white" : "bg-blue-900 text-white"}`}
          >
            <div className="p-4 flex items-start space-x-3">
              <div
                className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 ${toast.type === "success" ? "bg-green-500" : "bg-blue-500"}`}
              >
                {toast.type === "success" ? (
            ...
            <div
              className={`h-1 animate-progress ${toast.type === "success" ? "bg-green-400" : "bg-blue-400"}`}
            ></div>
          </Card>
        </div>
      )}
