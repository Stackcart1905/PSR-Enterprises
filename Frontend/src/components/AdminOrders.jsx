        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="p-5 lg:w-1/3 border-b lg:border-b-0 lg:border-r border-gray-100">
            <div className="flex items-center justify-between mb-3">
              ...
              <Badge
                className={`${getStatusColor(order.status)} border rounded-full font-medium`}
              >
                {order.status}
              </Badge>
            </div>
            ...
            <div className="space-y-2 text-sm text-gray-600">
              ...
              <div className="flex items-start">
                ...
                <span className="flex-1 line-clamp-2">
                  {order.deliveryInfo?.addressText}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="p-5 lg:w-48 bg-gray-50/50 flex flex-col justify-center space-y-2">
            {order.status === "Pending" ? (
              ...
              <div className="text-center py-2 flex flex-col items-center">
                <span className="text-[10px] font-black text-gray-400 uppercase tracking-tighter mb-1 font-mono">
                  Archive Record
                </span>
              ...
              <div className="space-y-6">
                <div>
                  <h4 className="text-xs font-black text-gray-400 uppercase tracking-widest mb-4 flex items-center">
                    <Receipt className="w-3 h-3 mr-1.5" /> Shipping Logistics
                  </h4>
                            ...
                            return (
                              <div className="space-y-1 mt-0.5">
                                <a
                                  ...
                                  className="inline-flex items-center text-xs bg-blue-600 text-white hover:bg-blue-700 px-3 py-1.5 rounded-md font-medium transition-colors shadow-sm"
                                >
                ...
                {order.adminNotes && (
                  <div>
                    ...
                    <p className="text-sm text-gray-700 italic bg-amber-50 p-3 rounded-lg border border-amber-100 font-medium">
                      "{order.adminNotes}"
                    </p>
                  </div>
                )}
...
const AdminOrders = () => {
  ...
  const handleUpdateStatus = async (orderId, status) => {
    if (
      !window.confirm(`Are you sure you want to set order status to ${status}?`)
    )
      return;
            ...
            <div className="p-4 flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-green-100 opacity-80">
                  {notification.customerName} placed an order of ₹
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500">
            View and manage customer orders, approvals, and logistics.
          </p>
        </div>
        <div className="flex items-center space-x-2">
          <Button
            ...
            size="sm"
            onClick={fetchOrders}
            className="h-10 hover:bg-green-50 hover:text-green-700 transition-colors"
          >
            ...
            <CardContent className="p-6 space-y-4">
              <div className="space-y-2">
                <label className="text-xs font-black text-gray-400 uppercase tracking-widest flex items-center">
                  <Calendar className="w-3 h-3 mr-2 text-green-600" /> Target
                  Delivery Date
                </label>
                <input
                  type="date"
              ...
              <div className="space-y-2">
                <label className="text-xs font-black text-gray-400 uppercase tracking-widest flex items-center">
                  <MessageSquare className="w-3 h-3 mr-2 text-green-600" />{" "}
                ...
                <p className="text-[10px] text-gray-400 italic">
                  Visible to customer on their dashboard.
                </p>
              </div>
