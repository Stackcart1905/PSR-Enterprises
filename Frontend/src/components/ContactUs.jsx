      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 lg:p-12">
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">swadbhogtraders@gmail.com</p>
                </div>
              </div>
            ...
            <div className="mt-8 p-6 bg-gradient-to-r from-green-50 to-yellow-50 rounded-2xl">
              <p className="text-sm text-gray-600 text-center">
                ...
                for the latest updates, offers, and healthy living tips.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 lg:p-12">
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                Feel free to fill out the form below with your message, and our
        ...
        <div className="mt-16 bg-white rounded-3xl shadow-2xl p-8 lg:p-12 text-center">
          <h3 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4">
            Why <span className="text-green-600">Choose</span> Swadbhog Mewa
            Traders?
          </h3>
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            We're committed to providing you with the best quality dry fruits
